...
import 'science_technology_page_item.dart';
...
class ScienceTechnology extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return new _ScienceTechnology();
  }
}

class _ScienceTechnology extends State<ScienceTechnology>
...
//        footer: MaterialFooter(),
        ...
        child: ListView.separated(
            itemBuilder: (BuildContext context, int index) {
              return ScienceTechnologyPageItem(items[index]);
            },
  ...
  getData(bool isRefresh, int time) async {
    ...
    var response = await NetUtils.get(
        "https://www.toutiao.com/api/pc/feed/?category=news_tech", _param);
    print(response);
